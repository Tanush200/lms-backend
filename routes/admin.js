...
//     const allowedRoles = ['admin', 'principal', 'teacher', 'student', 'parent', 'accountant', 'librarian'];
...
//     } else if (['teacher', 'admin', 'principal', 'accountant', 'librarian'].includes(role)) {
//       const employeeCount = await User.countDocuments({
//         role: { $in: ['teacher', 'admin', 'principal', 'accountant', 'librarian'] },
//       });
